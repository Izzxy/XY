...
import com.example.spring.controller.request.BookPageRequest;
...
public class BookController {
    ...
    public Result uploadFile(MultipartFile file) {
        ...
        try {
            ...
            if (originalFilename.endsWith("png") || originalFilename.endsWith("jpg") || originalFilename.endsWith("pnf")) {
                url += "&play=1";
            }
